...
const Gallery = () => {
  ...
  const allImages = [
    ...
    { id: 6, src: anime6, category: 'Anime', prompt: 'Cute anime character with colorful hair', likes: 142, downloads: 89, date: '2024-01-15', size: 'large' },
    { id: 7, src: anime7, category: 'Anime', prompt: 'Magical girl transformation sequence', likes: 98, downloads: 67, date: '2024-01-14', size: 'small' },
    { id: 8, src: anime9, category: 'Anime', prompt: 'Cyberpunk anime cityscape at night', likes: 256, downloads: 134, date: '2024-01-13', size: 'medium' },
    { id: 9, src: anime9, category: 'Anime', prompt: 'Fantasy anime warrior in forest', likes: 187, downloads: 92, date: '2024-01-12', size: 'large' },
    { id: 10, src: anime10, category: 'Anime', prompt: 'School anime scene with cherry blossoms', likes: 76, downloads: 45, date: '2024-01-11', size: 'small' },
    { id: 11, src: anime11, category: 'Anime', prompt: 'Cute anime character with colorful hair', likes: 142, downloads: 89, date: '2024-01-15', size: 'large' },
    { id: 12, src: anime12, category: 'Anime', prompt: 'Magical girl transformation sequence', likes: 98, downloads: 67, date: '2024-01-14', size: 'small' },
    { id: 13, src: anime13, category: 'Anime', prompt: 'Cyberpunk anime cityscape at night', likes: 256, downloads: 134, date: '2024-01-13', size: 'medium' },
    { id: 14, src: anime14, category: 'Anime', prompt: 'Fantasy anime warrior in forest', likes: 187, downloads: 92, date: '2024-01-12', size: 'large' },
    { id: 15, src: anime15, category: 'Anime', prompt: 'School anime scene with cherry blossoms', likes: 76, downloads: 45, date: '2024-01-11', size: 'small' },
    { id: 16, src: anime16, category: 'Anime', prompt: 'Cute anime character with colorful hair', likes: 142, downloads: 89, date: '2024-01-15', size: 'large' },
    { id: 17, src: anime17, category: 'Anime', prompt: 'Magical girl transformation sequence', likes: 98, downloads: 67, date: '2024-01-14', size: 'small' },
    { id: 18, src: anime18, category: 'Anime', prompt: 'Cyberpunk anime cityscape at night', likes: 256, downloads: 134, date: '2024-01-13', size: 'medium' },
    { id: 19, src: anime19, category: 'Anime', prompt: 'Fantasy anime warrior in forest', likes: 187, downloads: 92, date: '2024-01-12', size: 'large' },
    { id: 20, src: anime20, category: 'Anime', prompt: 'School anime scene with cherry blossoms', likes: 76, downloads: 45, date: '2024-01-11', size: 'small' },
